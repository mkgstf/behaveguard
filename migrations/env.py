...
# Make `src/` importable so `behaveguard.*` resolves the same way it does
# for the application (this migrations/ dir lives next to src/, not inside it).
sys.path.insert(0, str(Path(__file__).resolve().parents[1] / "src"))

from behaveguard.config import DATABASE_URL  # noqa: E402
from behaveguard.db.models import Base  # noqa: E402
